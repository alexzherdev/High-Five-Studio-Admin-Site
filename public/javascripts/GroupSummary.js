...
summaryRenderer: function(v, params, data){
    ...
    refreshSummaryById : function(gid){
        var g = this.grid.getGridEl().child('.x-grid3-scroller').down('.x-grid3-body');
        ...
        var cs = this.view.getColumnData(),
            ...
            existing = this.grid.getGridEl().child('.x-grid3-scroller').down('.x-grid3-body').down('.x-grid3-summary-row');
            
        if(existing) {
            g.dom.removeChild(existing.dom);
        }
